...
python ./plot_energy_v_rmsd.py --input_dir $scorefilepath/decoys.set1_Rosetta_orig_scores rosetta --input_dir $scorefilepath/decoys.set1_Rosetta_min rosetta --input_dir $scorefilepath/decoys.set1_Amber_min amber --rmsd_cutoff 100.0 "$output_path/e_v_r/decoys.set1"
python ./plot_energy_v_rmsd.py --input_dir $scorefilepath/decoys.set2_Rosetta_orig_scores rosetta --input_dir $scorefilepath/decoys.set2_Rosetta_min rosetta --input_dir $scorefilepath/decoys.set2_Amber_min amber --rmsd_cutoff 100.0 "$output_path/e_v_r/decoys.set2"
