...
def main(input_pdb, decoy_names_rosetta, decoy_names_amber):
    ...
    output_r_full = open(output_prefix+"_rosetta_true_control.csv", "a")
    output_a_full = open(output_prefix+"_amber_true_control.csv", "a")
    output_r_false = open(output_prefix+"_rosetta_false_control.csv", "a")
    output_a_false = open(output_prefix+"_amber_false_control.csv", "a")
